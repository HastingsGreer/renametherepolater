...
def make_unit(type, owner):
    units = {
       ...
       "boomboxer" : {"id": -1, "type": "boomboxer", "happiness":3, "owner":-1, "attack": "music burst", "attack_range":1}, #todo implement
       "bone dog" : {"id": -1, "type": "normie", "happiness":3, "owner":-1, "attack": "lick", "attack_range":1}, #todo implement
       "splab" : {"id": -1, "type": "normie", "happiness":3, "owner":-1, "attack": "bakaw", "attack_range":0} #todo implement
    }
